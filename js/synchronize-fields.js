...
(function () {
  ...
  window.synchronizeFields = function (inputElem, outElem, valuesIn, valuesOut, callback) {
  ...
  window.synchronizeFields(checkoutTime, checkoutTime, timeIn, timeOut, syncValues);
